...
import { LanguageProgressBar } from "@/components/common/language-progress-bar";
...
export default function IndexPage() {
  ...
  const personSchema = {
    ...
    sameAs: [siteConfig.links.github, siteConfig.links.tiktok],
  };
    ...
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          {/* TODO: swap this initials placeholder for a real <Image> once
              you add your own public/profile-img.jpg. */}
          <div
            className="bg-primary rounded-full mb-0 md:mb-2 w-[60%] max-w-[16rem] aspect-square border-8 border-primary flex items-center justify-center"
            aria-label={`${siteConfig.authorName} - ${siteConfig.tagline}`}
          >
            <span className="font-heading text-5xl sm:text-6xl md:text-7xl text-primary-foreground">
              {authorInitials}
            </span>
          </div>
          <AnimatedText
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              ...
              <Link
                ...
                aria-label={`Download ${siteConfig.authorName}'s CV`}
              >
